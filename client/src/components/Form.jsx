...
import {postAct} from '../Redux/reducers'
...
const Form = () => {
    ...
    const validateAct = (value) => {
            if(value.length < 3 ) {
                setError('Activitie name has to be more than 3 characters')
            } else{
                setError('')
            }
            setName(value)
        }
    const handleRadioChange = (event) => {event.preventDefault()
                          setTime(event.target.value)};
                        const handleDifChange = (event) => {event.preventDefault();
    ...
    return (
        ...
        <div className="form">
            <form>
  <label> Activitie Name:     </label>
  <input  type="text" id="fname" name="fname" placeholder="Activitie..."
                            autoComplete="off"
                            value={name}
                            onChange={(e) => {e.preventDefault();validateAct(e.target.value)}}/><br/>
  ...
  <label >   2h     </label>
  <input type="radio" id="radioB3" name="time" value="3"/>
  <label >   3h     </label>
  <input type="radio" id="radioB4" name="time" value="4"/>
  <label >   1/2 day    </label>
  <input type="radio" id="radioB5" name="time" value="5"/>
  <label >   1 day</label>
</form>    
</form>
                    <form>
